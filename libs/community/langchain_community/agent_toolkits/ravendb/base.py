...
from langchain_community.agent_toolkits.ravendb.prompt import (
    RQL_FUNCTIONS_SUFFIX,
    RQL_PREFIX,
    RQL_SUFFIX,
)
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        extra_tools: Additional tools to give to agent on top of the ones that come with
            RavenDBToolkit.
        db: RavenDB from which to create a RavenDBToolkit. Toolkit is created
    ...
    Example:
        ...
        .. code-block:: python
            ...
            agent_executor = create_ravendb_agent(llm, db=db, agent_type="tool-calling", verbose=True)
    ...
    toolkit = toolkit or RavenDBToolkit(llm=llm, db=db)  # type: ignore[arg-type]
    ...
    if agent_type == AgentType.ZERO_SHOT_REACT_DESCRIPTION:
        ...
        if prompt is None:
            messages: List = [
                ...
                AIMessage(content=suffix or RQL_FUNCTIONS_SUFFIX),
